  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="bg-white rounded-xl border p-6 mb-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-concrete-100 rounded-lg">
            <div>
              <p className="font-medium text-sm">Xendit Payment Gateway</p>
              <p className="text-xs text-concrete-600">QRIS, Kartu Kredit, Bank Transfer</p>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-concrete-100 rounded-lg">
            <div>
              ...
              <p className="text-xs text-concrete-600">Konfirmasi booking otomatis</p>
            </div>
            <span className="px-2 py-1 bg-green-100 text-green-700 text-xs rounded font-medium">
              Terhubung
            </span>
